...
# static fields
.field private static final ALT_ICON_DIR:Ljava/lang/String; = "/data/appicons"

.field private static final ALT_ICON_DIR_CALENDAR:Ljava/lang/String; = "/data/appicons/com.motorola.calendar"

.field private static final CALLENDAR_PACKAGE_NAME:Ljava/lang/String; = "com.motorola.calendar"
...
.method private getAltAppIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    .locals 9
    ...
    const-string v4, "/data/appicons"

    invoke-direct {v0, v4}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 648
    .local v0, altIconDir:Ljava/io/File;
    ...
    const-string v5, "Cannot access %s!!!"

    new-array v6, v7, [Ljava/lang/Object;

    const-string v7, "/data/appicons"
    ...
    .line 653
    .local v3, iconfile:Ljava/lang/String;
    new-instance v1, Ljava/io/File;

    invoke-direct {v1, v0, v3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 654
    .local v1, altIconSrc:Ljava/io/File;
    ...
    .line 655
    const-string v4, "com.motorola.calendar"
    ...
    const-string v5, "processing calendar app icon..."

    invoke-static {v4, v5}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 657
    invoke-direct {p0, p2}, Landroid/app/ApplicationPackageManager;->getCalendarIcon(I)Landroid/graphics/drawable/Drawable;
    ...
    const-string v5, "Failed to access %s!!!,pls check permission"
...
.method private getCalendarIcon(I)Landroid/graphics/drawable/Drawable;
    .locals 11
    .parameter "resid"
    ...
    const-string v6, "getCalendarIcon"
    ...
    .line 677
    .local v1, day:I
    const-string v5, "%s/day_%d_%d.png"

    const/4 v6, 0x3

    new-array v6, v6, [Ljava/lang/Object;

    const-string v7, "/data/appicons/com.motorola.calendar"
    ...
    const-string v7, "failed to access "
    ...
    const-string v6, "Failed to access %s!!!,pls check permission"
...
.method public getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2}, Landroid/app/ApplicationPackageManager;->getAltAppIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
