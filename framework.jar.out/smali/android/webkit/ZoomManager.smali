...
.field private final mBuiltInBackForward:Z
...
.field private mFixedOverviewWidth:Z
...
.method public constructor <init>(Landroid/webkit/WebView;Landroid/webkit/CallbackProxy;)V
    ...
    iput-boolean v0, p0, Landroid/webkit/ZoomManager;->mBuiltInBackForward:Z
...
.method private setupZoomOverviewWidth(Landroid/webkit/WebViewCore$DrawData;I)Z
    ...
    iget-boolean v2, p0, Landroid/webkit/ZoomManager;->mFixedOverviewWidth:Z
...
.method private zoom(F)Z
    ...
    invoke-virtual {v3, v5}, Landroid/webkit/WebView;->setTitleBarGravity(I)V
    ...
    iget v3, p0, Landroid/webkit/ZoomManager;->mMaxZoomScale:F
    ...
    invoke-static {v3, v1}, Landroid/webkit/ZoomManager;->exceedsMinScaleIncrement(FF)Z
...
.method public handleDoubleTap(FF)V
    ...
    .line 674
    .local v3, pluginBounds:Landroid/graphics/Rect;
    if-eqz v3, :cond_3

    .line 675
    iget-object v5, p0, Landroid/webkit/ZoomManager;->mWebView:Landroid/webkit/WebView;

    invoke-virtual {v5, v3}, Landroid/webkit/WebView;->isRectFitOnScreen(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v5, v3}, Landroid/webkit/WebView;->centerFitRect(Landroid/graphics/Rect;)V
    ...
    .line 709
    .local v1, latestTextWrapScale:F
    iget v6, p0, Landroid/webkit/ZoomManager;->mTextWrapScale:F
    ...
    .end local v1           #latestTextWrapScale:F
    .end local v2           #newTextWrapScale:F
    :cond_8
    iget v2, p0, Landroid/webkit/ZoomManager;->mActualScale:F

    .restart local v2       #newTextWrapScale:F
    goto :goto_1
...
.method onPageFinished(Ljava/lang/String;)V
    ...
    .line 1302
    iget-boolean v0, p0, Landroid/webkit/ZoomManager;->mBuiltInBackForward:Z
...
.method public setFixedZoomOverviewWidth(Z)V
    ...
    .prologue
    .line 1309
    iput-boolean p1, p0, Landroid/webkit/ZoomManager;->mFixedOverviewWidth:Z
