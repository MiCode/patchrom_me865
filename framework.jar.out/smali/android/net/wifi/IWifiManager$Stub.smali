...
.field static final TRANSACTION_getCtcwSipConfig:I = 0x2c
...
.field static final TRANSACTION_getPreferPreloadedSsid:I = 0x2a
...
.field static final TRANSACTION_isWifiEnabledAutonomous:I = 0x2f
...
.field static final TRANSACTION_setCtcwSipConfig:I = 0x2d

.field static final TRANSACTION_setFrequencyBand:I = 0x10

.field static final TRANSACTION_setPreferPreloadedSsid:I = 0x2b
...
.field static final TRANSACTION_setWifiEnabledAutonomous:I = 0x2e
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 468
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getPreferPreloadedSsid()Z
    ...
    .local v0, _arg0:Z
    :goto_1d
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setPreferPreloadedSsid(Z)Z
    ...
    .line 486
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getCtcwSipConfig()Landroid/net/wifi/WifiCtcwSipConfig;

    move-result-object v5

    .line 487
    .local v5, _result:Landroid/net/wifi/WifiCtcwSipConfig;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    invoke-virtual {v5, p3, v9}, Landroid/net/wifi/WifiCtcwSipConfig;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 499
    .end local v5           #_result:Landroid/net/wifi/WifiCtcwSipConfig;
    :sswitch_2d
    const-string v9, "android.net.wifi.IWifiManager"
    ...
    .line 502
    sget-object v9, Landroid/net/wifi/WifiCtcwSipConfig;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 507
    .local v0, _arg0:Landroid/net/wifi/WifiCtcwSipConfig;
    :goto_20
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setCtcwSipConfig(Landroid/net/wifi/WifiCtcwSipConfig;)Z
    ...
    .line 505
    .end local v0           #_arg0:Landroid/net/wifi/WifiCtcwSipConfig;
    .end local v5           #_result:Z
    :cond_1f
    const/4 v0, 0x0

    .restart local v0       #_arg0:Landroid/net/wifi/WifiCtcwSipConfig;
    goto :goto_20
