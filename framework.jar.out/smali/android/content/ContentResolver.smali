...
.method public notifyChange(Landroid/net/Uri;Landroid/database/ContentObserver;Z)V
    ...
    :cond_2
    invoke-virtual {p2}, Landroid/database/ContentObserver;->_getInternalToken()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    ...
    invoke-virtual {p3}, Landroid/database/ContentObserver;->_getInternalToken()I

    move-result v2

    invoke-interface {v0, p1, p2, v1, v2}, Landroid/content/IContentService;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/IContentObserver;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final unregisterContentObserver(Landroid/database/ContentObserver;)V
    ...
    invoke-virtual {p1}, Landroid/database/ContentObserver;->_getInternalToken()I

    move-result v2

    invoke-interface {v1, v0, v2}, Landroid/content/IContentService;->unregisterContentObserver(Landroid/database/IContentObserver;I)V
