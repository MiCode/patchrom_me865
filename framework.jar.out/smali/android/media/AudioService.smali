...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 283
    iput-boolean v6, p0, Landroid/media/AudioService;->mFMRadioRuning:Z
    ...
    .line 376
    iput-object v8, p0, Landroid/media/AudioService;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 377
    iput-object v8, p0, Landroid/media/AudioService;->mTelephonyManager2:Landroid/telephony/TelephonyManager;
    ...
    .line 3199
    iput v6, p0, Landroid/media/AudioService;->mPhoneState:I

    .line 3201
    iput v6, p0, Landroid/media/AudioService;->mPhoneState2:I
    ...
    .line 418
    sput v6, Landroid/media/AudioService;->mMotLdCardNum:I

    .line 419
    sput v6, Landroid/media/AudioService;->mLastUsbSpeakerNum:I

    .line 420
    sput v6, Landroid/media/AudioService;->mLastUsbMicNum:I
    ...
    .line 446
    const-string v3, "com.motorola.internal.intent.action.MOT_DOCK_EVENT"

    invoke-virtual {v0, v3}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 449
    const-string v3, "com.motorola.internal.intent.action.MEDIA_SPEAKER_ENABLE"

    invoke-virtual {v0, v3}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 452
    const-string v3, "com.motorola.intent.action.EXTDISP_STATUS_DISPLAY"
    ...
    .line 464
    const-string v3, "com.motorola.fmradio.state"
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    .line 488
    iget-object v3, p0, Landroid/media/AudioService;->mTelephonyManager:Landroid/telephony/TelephonyManager;
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mTelephonyManager2:Landroid/telephony/TelephonyManager;

    .line 491
    iget-object v3, p0, Landroid/media/AudioService;->mTelephonyManager2:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$7200(Landroid/media/AudioService;)Landroid/telephony/TelephonyManager;
    .locals 1
    .parameter "x0"

    .prologue
    .line 97
    iget-object v0, p0, Landroid/media/AudioService;->mTelephonyManager:Landroid/telephony/TelephonyManager;

    return-object v0
.end method

.method static synthetic access$7300(Landroid/media/AudioService;)Landroid/telephony/TelephonyManager;
    .locals 1
    .parameter "x0"

    .prologue
    .line 97
    iget-object v0, p0, Landroid/media/AudioService;->mTelephonyManager2:Landroid/telephony/TelephonyManager;
...
.method static synthetic access$7402(Landroid/media/AudioService;I)I
    ...
    .prologue
    .line 97
    iput p1, p0, Landroid/media/AudioService;->mPhoneState2:I
...
.method static synthetic access$7800(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$7900(Landroid/media/AudioService;)Ljava/util/Stack;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$8102(Landroid/media/AudioService;Landroid/media/IRemoteControlDisplay;)Landroid/media/IRemoteControlDisplay;
    .locals 0
    .parameter "x0"
    .parameter "x1"
