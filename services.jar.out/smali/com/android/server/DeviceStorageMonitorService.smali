...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageMonitor:Lcom/motorola/server/ExternalStorageMonitor;

    .line 103
    iput-boolean v8, p0, Lcom/android/server/DeviceStorageMonitorService;->usingFuse:Z

    .line 114
    new-instance v6, Lcom/android/server/DeviceStorageMonitorService$1;

    invoke-direct {v6, p0}, Lcom/android/server/DeviceStorageMonitorService$1;-><init>(Lcom/android/server/DeviceStorageMonitorService;)V

    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mHandler:Landroid/os/Handler;
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mContentResolver:Landroid/content/ContentResolver;
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mDataFileStats:Landroid/os/StatFs;
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mSystemFileStats:Landroid/os/StatFs;
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mCacheFileStats:Landroid/os/StatFs;
    ...
    iget-object v8, p0, Lcom/android/server/DeviceStorageMonitorService;->mDataFileStats:Landroid/os/StatFs;
    ...
    iput-wide v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mTotalMemory:J
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageLowIntent:Landroid/content/Intent;
    ...
    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageOkIntent:Landroid/content/Intent;

    .line 328
    iget-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageOkIntent:Landroid/content/Intent;
    ...
    const-string v7, "android.intent.action.DEVICE_STORAGE_FULL"

    invoke-direct {v6, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageFullIntent:Landroid/content/Intent;

    .line 330
    iget-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageFullIntent:Landroid/content/Intent;
    ...
    const-string v7, "android.intent.action.DEVICE_STORAGE_NOT_FULL"

    invoke-direct {v6, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNotFullIntent:Landroid/content/Intent;

    .line 332
    iget-object v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mStorageNotFullIntent:Landroid/content/Intent;
    ...
    iput-wide v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemLowThreshold:J
    ...
    iput v6, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemFullThreshold:I

    .line 337
    new-instance v6, Lcom/motorola/server/ExternalStorageMonitor;

    invoke-direct {v6, p1}, Lcom/motorola/server/ExternalStorageMonitor;-><init>(Landroid/content/Context;)V
    ...
    iput-boolean v11, p0, Lcom/android/server/DeviceStorageMonitorService;->usingFuse:Z
...
.method private final cancelNotification()V
    ...
    .prologue
    .line 391
    iget-boolean v1, p0, Lcom/android/server/DeviceStorageMonitorService;->usingFuse:Z

    if-eqz v1, :cond_0

    const-string v1, "sys.mot.fuse.write_protect"
...
.method private final sendNotification()V
    ...
    .line 360
    iget-boolean v6, p0, Lcom/android/server/DeviceStorageMonitorService;->usingFuse:Z

    if-eqz v6, :cond_0

    const-string v6, "sys.mot.fuse.write_protect"
