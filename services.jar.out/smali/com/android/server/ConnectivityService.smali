...
.field private static final EVENT_DEFAULT_DATA_NETWORK_CHANGED:I = 0xc9

.field private static final EVENT_DEFAULT_DATA_NETWORK_CHANGE_DELAY:I = 0xca
...
# instance fields
.field private SET_DATA_REASON_DEFAULT_DATA_CHANGED:I

.field private SET_DATA_REASON_UNKNOWN:I

.field private dataObserver:Lcom/android/server/ConnectivityService$DefaultDataNetworkObserver;

.field private isMobileDataEnabled:Z

.field private isSwitchingDefaultDataConnection:Z
...
.field private modemIdOfDefaultDataConnection:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->modemIdOfDefaultDataConnection:I
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->isSwitchingDefaultDataConnection:Z
    ...
    iput-boolean v2, v0, Lcom/android/server/ConnectivityService;->isMobileDataEnabled:Z
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_UNKNOWN:I
    ...
    iput v2, v0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_DEFAULT_DATA_CHANGED:I
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/server/ConnectivityService$DefaultDataNetworkObserver;-><init>(Lcom/android/server/ConnectivityService;Landroid/os/Handler;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->dataObserver:Lcom/android/server/ConnectivityService$DefaultDataNetworkObserver;
    ...
    iget-object v6, v0, Lcom/android/server/ConnectivityService;->dataObserver:Lcom/android/server/ConnectivityService$DefaultDataNetworkObserver;
...
.method static synthetic access$2500(Lcom/android/server/ConnectivityService;)V
    ...
    .prologue
    .line 120
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->onDefaultDataNetworkChanged()V
...
.method static synthetic access$2600(Lcom/android/server/ConnectivityService;)V
    ...
    .prologue
    .line 120
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->onDelayedDefaultDataNetworkChanaged()V
...
.method private allMobileDataDisconnected()Z
    .locals 7
    ...
    iget-object v5, v5, Landroid/net/NetworkConfig;->mLastState:Landroid/net/NetworkInfo$State;
    ...
    const-string v6, "[allMobileDataDisconnected] ==> net "
    ...
    const-string v6, " not disconnected, state="
    ...
    iget-object v6, v6, Landroid/net/NetworkConfig;->mLastState:Landroid/net/NetworkInfo$State;
...
.method private getNetworkInfo(II)Landroid/net/NetworkInfo;
    ...
    .line 879
    .local v3, wifiNetwork:Landroid/net/NetworkStateTracker;
    invoke-interface {v3, p1}, Landroid/net/NetworkStateTracker;->canHandleType(I)I
    ...
    .end local v3           #wifiNetwork:Landroid/net/NetworkStateTracker;
    :cond_1
    return-object v0
.end method
...
.method private handleConnectivityChange(IZ)V
    ...
    .line 2288
    .local v12, wifiNetwork:Landroid/net/NetworkStateTracker;
    if-eqz v12, :cond_0

    .line 2289
    move/from16 v0, p1

    invoke-interface {v12, v0}, Landroid/net/NetworkStateTracker;->canHandleType(I)I
    ...
    .line 2292
    const-string v13, "switch to wifi"
    ...
    .line 2309
    invoke-virtual {v2, v8}, Landroid/net/LinkProperties;->isIdenticalInterfaceName(Landroid/net/LinkProperties;)Z
    ...
    .line 2310
    invoke-virtual {v2, v8}, Landroid/net/LinkProperties;->compareAddresses(Landroid/net/LinkProperties;)Landroid/net/LinkProperties$CompareResult;
    ...
    .end local v12           #wifiNetwork:Landroid/net/NetworkStateTracker;
    :cond_4
    const/4 v10, 0x0
    ...
    .restart local v12       #wifiNetwork:Landroid/net/NetworkStateTracker;
    :cond_5
    new-instance v13, Ljava/lang/StringBuilder;
    ...
    invoke-direct {p0, v8, v2, v13}, Lcom/android/server/ConnectivityService;->updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Z)Z
    ...
    .line 2362
    invoke-static {v5, v10}, Landroid/net/NetworkUtils;->resetConnections(Ljava/lang/String;I)I
...
.method private handleSetMobileData(Z)V
    ...
    .prologue
    .line 1725
    iget v0, p0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_UNKNOWN:I

    invoke-direct {p0, p1, v0}, Lcom/android/server/ConnectivityService;->handleSetMobileData(ZI)V
...
.method private handleSetMobileData(ZI)V
    ...
    .line 1732
    iget-boolean v6, p0, Lcom/android/server/ConnectivityService;->isSwitchingDefaultDataConnection:Z

    if-eqz v6, :cond_1

    iget v6, p0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_DEFAULT_DATA_CHANGED:I

    if-eq p2, v6, :cond_1

    .line 1733
    iput-boolean p1, p0, Lcom/android/server/ConnectivityService;->isMobileDataEnabled:Z
    ...
    invoke-interface {v6, p1}, Landroid/net/NetworkStateTracker;->setUserDataEnable(Z)V
    ...
    const-string v7, "Active default network: "
    ...
    const-string v7, " has higher priority, don\'t start it"
    ...
    invoke-interface {v6}, Landroid/net/NetworkStateTracker;->reconnect()Z
...
.method private onDefaultDataNetworkChanged()V
    ...
    .prologue
    .line 3646
    iget-boolean v1, p0, Lcom/android/server/ConnectivityService;->isSwitchingDefaultDataConnection:Z
    ...
    .line 3651
    .local v0, modemIdOfNewDefaultDataConnection:I
    iget v1, p0, Lcom/android/server/ConnectivityService;->modemIdOfDefaultDataConnection:I
    ...
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->isMobileDataEnabled:Z

    .line 3663
    const/4 v1, 0x0

    iget v2, p0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_DEFAULT_DATA_CHANGED:I

    invoke-direct {p0, v1, v2}, Lcom/android/server/ConnectivityService;->setMobileDataEnabled(ZI)V
    ...
    invoke-direct {p0}, Lcom/android/server/ConnectivityService;->allMobileDataDisconnected()Z
    ...
    iput-boolean v1, p0, Lcom/android/server/ConnectivityService;->isSwitchingDefaultDataConnection:Z
...
.method private onDelayedDefaultDataNetworkChanaged()V
    .locals 4
    ...
    iput v0, p0, Lcom/android/server/ConnectivityService;->modemIdOfDefaultDataConnection:I

    .line 3700
    iget v0, p0, Lcom/android/server/ConnectivityService;->modemIdOfDefaultDataConnection:I

    invoke-direct {p0, v0}, Lcom/android/server/ConnectivityService;->setDefaultDataConnection(I)V

    .line 3702
    const/4 v0, 0x1

    iget v1, p0, Lcom/android/server/ConnectivityService;->SET_DATA_REASON_DEFAULT_DATA_CHANGED:I

    invoke-direct {p0, v0, v1}, Lcom/android/server/ConnectivityService;->setMobileDataEnabled(ZI)V

    .line 3703
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/server/ConnectivityService;->isSwitchingDefaultDataConnection:Z

    .line 3704
    iget-boolean v0, p0, Lcom/android/server/ConnectivityService;->isMobileDataEnabled:Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/ConnectivityService;->setMobileDataEnabled(Z)V
...
.method private setDefaultDataConnection(I)V
    .locals 7
    .parameter "modemId"
    ...
    const-string v6, "setDefaultDataConnection "
    ...
    .end local v4           #nt:Landroid/net/NetworkStateTracker;
    invoke-virtual {v4, p1}, Landroid/net/MobileDataStateTracker;->setDefaultDataConnection(I)V
...
.method private setMobileDataEnabled(ZI)V
    .locals 4
    .parameter "enabled"
    .parameter "reason"
    ...
    :goto_0
    invoke-virtual {v2, v3, v0, p2}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
...
.method public requestRouteToHostAddress(I[B)Z
    ...
    .line 1499
    .local v7, wifiNetwork:Landroid/net/NetworkStateTracker;
    iget-object v9, p0, Lcom/android/server/ConnectivityService;->mNetTrackers:[Landroid/net/NetworkStateTracker;
    ...
    .line 1501
    invoke-interface {v7, p1}, Landroid/net/NetworkStateTracker;->canHandleType(I)I
...
.method public setMobileDataEnabled(Z)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/ConnectivityService;->setMobileDataEnabled(ZI)V
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    const-string v18, "startUsingNetworkFeature for net "
    ...
    .line 1185
    .local v16, wifiNetwork:Landroid/net/NetworkStateTracker;
    if-eqz v16, :cond_3

    .line 1186
    move-object/from16 v0, v16

    invoke-interface {v0, v15}, Landroid/net/NetworkStateTracker;->canHandleType(I)I
    ...
    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->getRestoreDefaultNetworkDelay(I)I
    ...
    invoke-virtual {v14, v6}, Lcom/android/server/ConnectivityService$FeatureUser;->isSameUser(Lcom/android/server/ConnectivityService$FeatureUser;)Z
    ...
    invoke-virtual {v2, v0, v1, v15}, Lmiui/net/FirewallManager;->onStartUsingNetworkFeature(III)V
    ...
    invoke-direct {v0, v15}, Lcom/android/server/ConnectivityService;->handleDnsConfigurationChange(I)V

    .line 1266
    const-string v17, "special network already active"
    ...
    .end local v8           #network:Landroid/net/NetworkStateTracker;
    ...
    .restart local v8       #network:Landroid/net/NetworkStateTracker;
    .restart local v9       #ni:Landroid/net/NetworkInfo;
    .restart local v10       #restoreTimer:I
    :cond_9
    :try_start_2
    ...
    .end local v12           #token:J
    :cond_a
    const-string v17, "special network already connecting"
    ...
    const-string v18, "startUsingNetworkFeature reconnecting to "
...
.method public stopUsingNetworkFeature(ILjava/lang/String;)I
    ...
    .line 1313
    .local v8, wifiNetwork:Landroid/net/NetworkStateTracker;
    if-eqz v8, :cond_0
    ...
    .line 1315
    .local v4, type:I
    invoke-interface {v8, v4}, Landroid/net/NetworkStateTracker;->canHandleType(I)I
    ...
    .line 1342
    .local v9, x:Lcom/android/server/ConnectivityService$FeatureUser;
    invoke-virtual {v9, v2, v6, p1, p2}, Lcom/android/server/ConnectivityService$FeatureUser;->isSameUser(IIILjava/lang/String;)Z
    ...
    .line 1351
    invoke-direct {p0, v5, v10}, Lcom/android/server/ConnectivityService;->stopUsingNetworkFeature(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    .end local v2           #pid:I
    .end local v5           #u:Lcom/android/server/ConnectivityService$FeatureUser;
    .end local v6           #uid:I
    ...
    .restart local v5       #u:Lcom/android/server/ConnectivityService$FeatureUser;
    ...
    :cond_4
    const-string v11, "stopUsingNetworkFeature - not a live request, ignoring"
