...
.field private static final DIALOG_START_IME:I = 0x1

.field private static final DIALOG_SWITCH_IME:I = 0x2

.field private static final DO_NOT_SHOW_EXTERNAL:Ljava/lang/String; = "do_not_show_external_keyboard_notification"

.field private static final MOTOROLA_IME:Ljava/lang/String; = "com.motorola.inputmethod.latinime"
...
.field private static final SWIFTKEY_IME:Ljava/lang/String; = "com.touchtype.swiftkey.motorola"

.field private static final SWYPE_IME:Ljava/lang/String; = "com.swype.android.inputmethod"
...
.field private mExtKeyboardBuilder:Landroid/app/AlertDialog$Builder;

.field private mExtKeyboardDialog:Landroid/app/AlertDialog;

.field private mExtKeyboardNotificationShown:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 584
    iput-boolean v11, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardNotificationShown:Z
...
.method static synthetic access$1000(Lcom/android/server/InputMethodManagerService;)Landroid/app/AlertDialog$Builder;
    .locals 1
    .parameter "x0"

    .prologue
    .line 121
    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardBuilder:Landroid/app/AlertDialog$Builder;

    return-object v0
.end method

.method static synthetic access$1102(Lcom/android/server/InputMethodManagerService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 121
    iput-boolean p1, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardNotificationShown:Z
...
.method static synthetic access$1400(Lcom/android/server/InputMethodManagerService;Landroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodInfo;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 121
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/InputMethodManagerService;->checkAndShowExtKeyboardNotification(Landroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodInfo;I)V
...
.method static synthetic access$1800(Landroid/content/res/Resources;Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$600(Lcom/android/server/InputMethodManagerService;)Z
    ...
    .prologue
    .line 121
    iget-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mIsChecked:Z
...
.method static synthetic access$602(Lcom/android/server/InputMethodManagerService;Z)Z
    ...
    .prologue
    .line 121
    iput-boolean p1, p0, Lcom/android/server/InputMethodManagerService;->mIsChecked:Z

    return p1
.end method

.method static synthetic access$700(Lcom/android/server/InputMethodManagerService;Landroid/content/SharedPreferences;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 121
    invoke-direct {p0, p1, p2}, Lcom/android/server/InputMethodManagerService;->savePrefsValue(Landroid/content/SharedPreferences;Z)V
...
.method static synthetic access$900(Lcom/android/server/InputMethodManagerService;)Landroid/app/AlertDialog;
    .locals 1
    .parameter "x0"

    .prologue
    .line 121
    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardDialog:Landroid/app/AlertDialog;

    return-object v0
.end method

.method static synthetic access$902(Lcom/android/server/InputMethodManagerService;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 121
    iput-object p1, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardDialog:Landroid/app/AlertDialog;
...
.method private checkAndShowExtKeyboardNotification(Landroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodInfo;I)V
    .locals 6
    .parameter "curMethod"
    .parameter "toMethod"
    .parameter "subtypeId"
    ...
    invoke-virtual {p0, v4, p3}, Lcom/android/server/InputMethodManagerService;->setInputMethodLocked(Ljava/lang/String;I)V
    ...
    iget-boolean v4, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardNotificationShown:Z
    ...
    invoke-direct {p0, v2}, Lcom/android/server/InputMethodManagerService;->checkPrefsValue(Landroid/content/SharedPreferences;)Z
    ...
    .line 1309
    .local v1, curMethodPackageName:Ljava/lang/String;
    invoke-virtual {p2}, Landroid/view/inputmethod/InputMethodInfo;->getPackageName()Ljava/lang/String;

    move-result-object v3

    .line 1310
    .local v3, toMethodPackageName:Ljava/lang/String;
    const-string v4, "com.motorola.inputmethod.latinime"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/InputMethodManagerService;->isNeedShowNotificationIME(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p2, v4}, Lcom/android/server/InputMethodManagerService;->showSwitchIMENotification(Landroid/view/inputmethod/InputMethodInfo;I)V

    goto :goto_0
.end method

.method private checkPrefsValue(Landroid/content/SharedPreferences;)Z
    .locals 2
    .parameter "prefs"

    .prologue
    .line 1280
    const-string v0, "do_not_show_external_keyboard_notification"
...
.method private isNeedShowNotificationIME(Ljava/lang/String;)Z
    .locals 1
    .parameter "packageName"

    .prologue
    .line 1289
    const-string v0, "com.swype.android.inputmethod"
    ...
    const-string v0, "com.touchtype.swiftkey.motorola"
...
.method private savePrefsValue(Landroid/content/SharedPreferences;Z)V
    .locals 3
    .parameter "prefs"
    .parameter "value"
    ...
    const-string v1, "do_not_show_external_keyboard_notification"
...
.method private showInputMethodMenuInternal(Z)V
    ...
    new-instance v31, Lcom/android/server/InputMethodManagerService$9;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/InputMethodManagerService$9;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/content/pm/PackageManager;)V
    ...
    new-instance v33, Lcom/android/server/InputMethodManagerService$10;
    ...
    new-instance v33, Lcom/android/server/InputMethodManagerService$11;
    ...
    new-instance v34, Lcom/android/server/InputMethodManagerService$12;

    move-object/from16 v0, v34

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/InputMethodManagerService$12;-><init>(Lcom/android/server/InputMethodManagerService;)V
...
.method private showSwitchIMENotification(Landroid/view/inputmethod/InputMethodInfo;I)V
    .locals 11
    .parameter "imi"
    .parameter "dialogId"
    ...
    invoke-direct {p0, v7}, Lcom/android/server/InputMethodManagerService;->checkPrefsValue(Landroid/content/SharedPreferences;)Z
    ...
    invoke-direct {p0, v5}, Lcom/android/server/InputMethodManagerService;->isNeedShowNotificationIME(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v6}, Landroid/view/inputmethod/InputMethodInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
    ...
    iput-boolean v8, p0, Lcom/android/server/InputMethodManagerService;->mIsChecked:Z

    .line 1329
    new-instance v8, Lcom/android/server/InputMethodManagerService$3;

    invoke-direct {v8, p0, v1}, Lcom/android/server/InputMethodManagerService$3;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/widget/CheckBox;)V
    ...
    iput-object v8, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardBuilder:Landroid/app/AlertDialog$Builder;
    ...
    .line 1338
    iget-object v8, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardBuilder:Landroid/app/AlertDialog$Builder;

    new-instance v9, Lcom/android/server/InputMethodManagerService$4;

    invoke-direct {v9, p0, v7}, Lcom/android/server/InputMethodManagerService$4;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/content/SharedPreferences;)V
    ...
    invoke-direct {v10, p0, v7}, Lcom/android/server/InputMethodManagerService$5;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/content/SharedPreferences;)V
    ...
    :cond_2
    :goto_1
    iget-object v8, p0, Lcom/android/server/InputMethodManagerService;->mHandler:Landroid/os/Handler;

    new-instance v9, Lcom/android/server/InputMethodManagerService$8;

    invoke-direct {v9, p0}, Lcom/android/server/InputMethodManagerService$8;-><init>(Lcom/android/server/InputMethodManagerService;)V
    ...
    new-instance v10, Lcom/android/server/InputMethodManagerService$6;

    invoke-direct {v10, p0, v7}, Lcom/android/server/InputMethodManagerService$6;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/content/SharedPreferences;)V
    ...
    new-instance v10, Lcom/android/server/InputMethodManagerService$7;

    invoke-direct {v10, p0, v7}, Lcom/android/server/InputMethodManagerService$7;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/content/SharedPreferences;)V
...
.method hideInputMethodMenuLocked()V
    ...
    .line 2541
    iput-object v1, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardDialog:Landroid/app/AlertDialog;

    .line 2543
    :cond_1
    iput-object v1, p0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardBuilder:Landroid/app/AlertDialog$Builder;
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    iget-object v14, v0, Lcom/android/server/InputMethodManagerService;->mCurToken:Landroid/os/IBinder;
    ...
    .line 1203
    :cond_0
    const-string v14, "InputManagerService"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "Ignoring setImeWindowStatus of uid "
    ...
    .line 1210
    .local v9, pendingShowSwitchIMENotification:Z
    const/4 v7, 0x0
    ...
    iget-object v14, v0, Lcom/android/server/InputMethodManagerService;->mStatusBar:Lcom/android/server/StatusBarManagerService;
    ...
    invoke-virtual {v14, v0, v1, v2}, Lcom/android/server/StatusBarManagerService;->setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    iget-object v14, v0, Lcom/android/server/InputMethodManagerService;->mRes:Landroid/content/res/Resources;
    ...
    iget-boolean v14, v0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardNotificationShown:Z

    if-nez v14, :cond_4

    iget v14, v3, Landroid/content/res/Configuration;->keyboard:I
    ...
    iput-boolean v14, v0, Lcom/android/server/InputMethodManagerService;->mExtKeyboardNotificationShown:Z
    ...
    iget-object v14, v0, Lcom/android/server/InputMethodManagerService;->mWebtopManager:Lcom/motorola/webtop/WebtopManager;

    invoke-virtual {v14}, Lcom/motorola/webtop/WebtopManager;->isWebtopMode()Z
    ...
    invoke-virtual {v7, v10}, Landroid/view/inputmethod/InputMethodInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;

    move-result-object v8

    .line 1235
    .local v8, imiLabel:Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v17 .. v20}, Landroid/view/inputmethod/InputMethodSubtype;->getDisplayName(Landroid/content/Context;Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v14, v0, v12, v11, v1}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V

    .line 1244
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/InputMethodManagerService;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    invoke-virtual {v14, v0, v1}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V
    ...
    iput-boolean v14, v0, Lcom/android/server/InputMethodManagerService;->mNotificationShown:Z

    .line 1259
    .end local v8           #imiLabel:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v7, v14}, Lcom/android/server/InputMethodManagerService;->showSwitchIMENotification(Landroid/view/inputmethod/InputMethodInfo;I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    .end local v9           #pendingShowSwitchIMENotification:Z
    :catchall_0
    move-exception v14
    ...
    .restart local v9       #pendingShowSwitchIMENotification:Z
    :cond_7
    const/4 v4, 0x0
    ...
    .restart local v8       #imiLabel:Ljava/lang/CharSequence;
    ...
    iget-boolean v14, v0, Lcom/android/server/InputMethodManagerService;->mNotificationShown:Z
