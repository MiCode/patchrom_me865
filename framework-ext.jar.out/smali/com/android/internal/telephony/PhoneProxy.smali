...
.field private static final ACTION_SECONDARY_NETWORKMODE_SWITCH:Ljava/lang/String; = "com.motorola.intent.action.NETWORKMODE_SWITCH_2"

.field private static final EVENT_MODE_CHANGE_COMPLETE:I = 0x2
...
.method public constructor <init>(ILcom/android/internal/telephony/Phone;)V
    ...
    .line 86
    iput-boolean v3, p0, Lcom/android/internal/telephony/PhoneProxy;->mIsNewArch:Z
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemConfigManager:Lcom/motorola/android/internal/telephony/ModemConfigManager;

    .line 114
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneProxy;->isDefault()Z
    ...
    .line 121
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemConfigManager:Lcom/motorola/android/internal/telephony/ModemConfigManager;

    iget v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemId:I

    invoke-virtual {v1, v4}, Lcom/motorola/android/internal/telephony/ModemConfigManager;->getModemInfo(I)Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mModem:Lcom/motorola/android/internal/telephony/ModemConfigManager$ModemInfo;
    ...
    invoke-interface {v1, p0, v2, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForRadioTechnologyChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, p0, v6, v7}, Lcom/motorola/android/internal/telephony/PhoneModeService;->registerModeChangeComplete(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 114
    :cond_1
    const-string v1, "persist.radio.reset_on_switch.2"
...
.method private handleMessageForNewArch(Landroid/os/Message;)V
    ...
    .line 248
    :cond_a
    const-string v4, "android.intent.action.RADIO_TECHNOLOGY_2"
    ...
    .end local v3           #oldPowerState:Z
    :pswitch_1
    const-string v4, "EVENT_MODE_CHANGE_COMPLETE"
    ...
    invoke-virtual {v4, v5}, Lcom/motorola/android/internal/telephony/PhoneModeService;->isDefaultModemId(I)Z
    ...
    const-string v5, "publish default modem ID = "
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/IccSmsInterfaceManagerProxy;->publish()V

    .line 261
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccPhoneBookInterfaceManagerProxy:Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;

    invoke-virtual {v4}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;->publish()V

    .line 262
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneSubInfoProxy:Lcom/android/internal/telephony/PhoneSubInfoProxy;

    invoke-virtual {v4}, Lcom/android/internal/telephony/PhoneSubInfoProxy;->publish()V
    ...
    invoke-virtual {v4, p0}, Lcom/motorola/android/internal/telephony/PhoneModeService;->unregisterModeChangeComplete(Landroid/os/Handler;)V
    ...
    const-string v5, "publish secondary modem ID = "
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/IccSmsInterfaceManagerProxy;->publishSecondary()V

    .line 266
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mIccPhoneBookInterfaceManagerProxy:Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;

    invoke-virtual {v4}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManagerProxy;->publishSecondary()V

    .line 267
    iget-object v4, p0, Lcom/android/internal/telephony/PhoneProxy;->mPhoneSubInfoProxy:Lcom/android/internal/telephony/PhoneSubInfoProxy;

    invoke-virtual {v4}, Lcom/android/internal/telephony/PhoneSubInfoProxy;->publishSecondary()V
...
.method private final isDefault()Z
    ...
    iget v2, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemId:I

    invoke-virtual {v1, v2}, Lcom/motorola/android/internal/telephony/PhoneModeService;->isDefaultModemId(I)Z
    :try_end_0
    ...
    iget v1, p0, Lcom/android/internal/telephony/PhoneProxy;->mModemId:I

    invoke-static {v1}, Lcom/motorola/android/telephony/PhoneModeManager;->isDefaultModemId(I)Z
...
.method public activateIcc(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->activateIcc(Landroid/os/Message;)V
...
.method public deactivateIcc(Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->deactivateIcc(Landroid/os/Message;)V
...
.method public enable(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/Phone;->enable(Z)V
...
.method public selectNetwork(ILjava/lang/String;ILandroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/android/internal/telephony/Phone;->selectNetwork(ILjava/lang/String;ILandroid/os/Message;)V
...
.method public setPreferredNetworkInfo(Lcom/motorola/android/internal/telephony/gsm/PreferredNetworkInfo;Landroid/os/Message;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/android/internal/telephony/Phone;->setPreferredNetworkInfo(Lcom/motorola/android/internal/telephony/gsm/PreferredNetworkInfo;Landroid/os/Message;)V
...
.method public setPreferredNetworkType(ILandroid/os/Message;)V
    ...
    .end local v0           #intent:Landroid/content/Intent;
    :cond_0
    const-string v1, "com.motorola.intent.action.NETWORKMODE_SWITCH_2"
